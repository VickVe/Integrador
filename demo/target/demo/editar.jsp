			...
			<div class="container">
				<section>
					...
					<form method="POST"
						...
						<div class="mb-2">
							<label for="exampleFormControlInput1" class="form-label">Importador</label>
							<input name="importador"
								value="<%=producto.getImportador()%>"  
								type="text" class="form-control" id="exampleFormControlInput1" placeholder="Importador" maxlength="50">
						  </div>
